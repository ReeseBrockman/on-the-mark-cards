...
function ProductGrid() {
  const { products, loading } = useProducts("Card Sleeves");
...
export default function CardSleevesPage() {
  return (
    <div className="bg-black min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <span className="text-gray-500 text-sm mx-2">/</span>
          <span className="text-white text-sm">Card Sleeves</span>
        </div>
        <h1 className="text-white text-3xl font-bold mb-8">Card Sleeves</h1>
        <ProductGrid />
      </div>
    </div>
  );
