...
const categories = ["All", "Deck Boxes", "Dice", "Playmats"];
...
export default function TCGSuppliesPage() {
    ...
    <div className="bg-black min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <span className="text-white text-sm">TCG Supplies</span>
        </div>

        <h1 className="text-white text-3xl font-bold mb-8">TCG Supplies</h1>
