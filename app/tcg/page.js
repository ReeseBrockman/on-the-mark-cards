...
const bannerSlides = [
  {
    ...
    buttonBg:
      "bg-green-500 hover:bg-white text-white hover:text-green-500 border border-green-500",
  },
  {
    ...
    subtitleColor: "text-white font-semibold",
    buttonBg:
      "bg-blue-300 hover:bg-white text-white hover:text-blue-300 border border-blue-300",
  },
];
